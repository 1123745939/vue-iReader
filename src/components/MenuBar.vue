  ...
  <div class="menu-bar">
    <transition name="slide-up">
      <div class="menu-wrapper"
        :class="{'hide-box-shadow':ifSettingShow || !TitleAndMenuShow}"
        ...
        <div class="setting-theme"
          ...
          <div class="setting-theme-item"
            ...
            <div class="preview"
              ...
              :class="{'noboder':item.style.body.background !=='#fff'}">
            </div>
            <div class="text"
              :class="{'selceted':index === defaultTheme}">
              {{ item.name }}
            </div>
          </div>
        </div>
        <div class="setting-progress"
          ...
          <div class="progress-wrapper">
            <input type="range"
              ...
              :value="progress"
              :disabled="!bookAvailabe"
              ref="progress">
          </div>
          <div class="text-wrapper">
            <span>{{ bookAvailabe ? progress + '%' : '加载中...' }}</span>
          </div>
        </div>
      </div>
    </transition>
